...
import ProjectContainer from "components/Container/ProjectModalContainer";
...
const urlRequest = process.env.REACT_APP_SERVER_URL + "/api/projects/";
  ...
  return (
    <GridContainer>
      ...
      <GridItem xs={12} sm={12} md={12}>
        <div>
          <ProjectContainer triggertext="Thêm Dự án" />
        </div>
        <Card>
